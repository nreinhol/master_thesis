...
According to \shortciteA{guo2007market}, the bundle determination problem have either 
...
Furthermore, the market has a dealer who trades on its own account. 
The dealer has some initial cash endowment $e_{0}$ and resource endowment $c_{0}$.
Anyway, the sum of all resource endowments needs to fulfill the following equation:
...
Concluding, this subsection will give an overview of the synchronous
...
\begin{description}
 ...
 bundle determination problem and adds new limited bundle orders to $I_{j}$ and 
