...
the ledger \shortcite{andoni2019blockchain}. But, in some cases, central management is not practicable or reasonable. 
...
Referring to the \textit{Yellow Paper} by \shortciteA{wood2014ethereum}, Ethereum 
...
Moreover, a block is a collection of different relevant informations and 
...
by \shortciteA{wood2014ethereum}, the subsequent pieces of information are 
...
So far, we introduced Ethereum as a transaction-based state machine, transforming 
...
the standardized Ethereum protocol, wherefore they can operate and interact with the same Ethereum network. \shortcite{antonopoulos2018mastering}. 
...
First, each client can join the peer-to-peer Ethereum network. 
...
As mentioned above, there are differences in client behavior regarding the synchronizing modes. 
