...
because Ethereum smart contracts are neither smart nor legal contracts \shortcite{antonopoulos2018mastering}

- Immutable computer program that run deterministically in the context of an 
Ethereum Virtual Machine as part of the networkprotocol \shortcite{antonopoulos2018mastering}
