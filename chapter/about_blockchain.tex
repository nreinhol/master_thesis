...
and illustrated in the figure \ref{figure:node_network}, nodes can be distinguished into different types. 
This section will describe the concept of a node in general and will give a brief overview of the different
types.

In general, an Ethereum node (often also called client) is a software application 
that implements the Ethereum specification and communicates over 
...
the standardized ethereum protocol \shortcite{antonopoulos2018mastering}. 
Therefore, they are able to operate and interact with the same Ethereum network. 
