...
First, the agent get the current market prices from the dealer's smart contract.
...
\begin{comment}
Finally, it is examined if both solutions are identical. 
If this is the case, the class variable \verb|accept_trade| of type boolean is
set to \verb|True|, otherwise to \verb|False|.
\end{comment}
